    ...
    return (
        <div className="logIn">
            ...
            <div className="text-center pt-5 text-light">
                <div>
                    <h1 className="text-light px-5 mx-5 pt-5">Welcome To Epic Eateries .Please Sign In With Your Google Account To See Your Ordered Services And To Confirm It...!!!!</h1>
                </div>
